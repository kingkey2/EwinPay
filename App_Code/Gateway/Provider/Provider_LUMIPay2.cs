...
/// </summary>
public class Provider_LUMIPay2 : GatewayCommon.ProviderGateway, GatewayCommon.ProviderGatewayByWithdraw
{

    public Provider_LUMIPay2()
    {
        //初始化設定檔資料
        SettingData = GatewayCommon.GetProverderSettingData("LUMIPay2");
    }
