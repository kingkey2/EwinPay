...
/// </summary>
public class Provider_PoPay : GatewayCommon.ProviderGateway, GatewayCommon.ProviderGatewayByWithdraw
{

    public Provider_PoPay()
    {
        //初始化設定檔資料
        SettingData = GatewayCommon.GetProverderSettingData("PoPay");
    }
