...
/// </summary>
public class Provider_JBPay : GatewayCommon.ProviderGateway, GatewayCommon.ProviderGatewayByWithdraw
{

    public Provider_JBPay()
    {
        //初始化設定檔資料
        SettingData = GatewayCommon.GetProverderSettingData("JBPay");
    }
