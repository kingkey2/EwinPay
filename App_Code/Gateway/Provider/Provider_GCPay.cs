...
/// </summary>
public class Provider_GCPay : GatewayCommon.ProviderGateway, GatewayCommon.ProviderGatewayByWithdraw
{

    public Provider_GCPay()
    {
        //初始化設定檔資料
        SettingData = GatewayCommon.GetProverderSettingData("GCPay");
    }
    ...
    string GatewayCommon.ProviderGateway.GetCompleteUrl(GatewayCommon.Payment payment)
    {
        ...
        signDic.Add("pay_channel_id", "1302");//
