...
/// </summary>
public class Provider_DiDiPay2 : GatewayCommon.ProviderGateway, GatewayCommon.ProviderGatewayByWithdraw
{

    public Provider_DiDiPay2()
    {
        //初始化設定檔資料
        SettingData = GatewayCommon.GetProverderSettingData("DiDiPay2");
    }
